...
private:
	...
	// Tambah: handler untuk Offer dan fungsi request
	Duck::Result do_offer(const DHCPPacket& packet);
	Duck::Result request(const Interface& interface, int txid, const IPv4Address& offered_ip, const IPv4Address& server_ip);
