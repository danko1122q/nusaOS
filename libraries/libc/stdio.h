...
#ifndef NUSAOS_LIBC_STDIO_H
#define NUSAOS_LIBC_STDIO_H

// We have to add this to get GCC to build for nusaOS for some reason. May be fixed with a newer version of GCC.
#ifdef GCC_SYSTEM_H
