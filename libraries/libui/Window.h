...
namespace UI {
	...
	public:
		...
		bool resizable();
		void set_show_min_max_buttons(bool show);
		bool is_focused();
		bool is_closed();
		bool is_maximized();
	...
	private:
		...
		bool _show_min_max_buttons = true;
		...
		TitleButton _maximize_button = {"win-maximize"};
	};
