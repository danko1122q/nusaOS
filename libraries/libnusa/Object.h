...
/** \see{Duck::Object} */
#define NUSA_OBJECT_VIRTUAL(name) 									\
...
namespace Duck {
	 ...
	 *
	 * The NUSA_OBJECT_VIRTUAL macro only defines `object_name`.
	 */
